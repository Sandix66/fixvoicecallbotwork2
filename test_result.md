...
agent_communication:
  ...
  - agent: "main"
    message: "LATEST UPDATE: Added Deepgram TTS integration with 51 voice options. Updated default Step 1 message. Implemented per-minute billing ($0.5 regular, $0.8 spoofing) with incremental charging. Added spoofing permission system. Added 9 new SignalWire numbers (total: 10). Backend restarted clean without errors. Ready for testing."